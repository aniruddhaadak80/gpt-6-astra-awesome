# 🎚️ Reasoning Effort Tuning - 120 copyable GPT-6 Astra prompts
...
<details>
<summary><code>reasoning-effort-091</code> - pick effort for a CRUD ticket vs a distributed bug (click to expand)</summary>
...
<details>
<summary><code>reasoning-effort-092</code> - decide when xhigh/max is justified with a checklist (click to expand)</summary>
...
<details>
<summary><code>reasoning-effort-093</code> - write an incident note when max still fails (click to expand)</summary>
...
<details>
<summary><code>reasoning-effort-094</code> - tune effort for long-doc QA vs short chat (click to expand)</summary>
...
<details>
<summary><code>reasoning-effort-095</code> - create an effort-selection flowchart (click to expand)</summary>
...
<details>
<summary><code>reasoning-effort-096</code> - build a prompt+effort matrix for support macros (click to expand)</summary>
...
<details>
<summary><code>reasoning-effort-097</code> - tune verification depth alongside effort (click to expand)</summary>
...
<details>
<summary><code>reasoning-effort-098</code> - measure cost-per-task across efforts with retries counted (click to expand)</summary>
...
<details>
<summary><code>reasoning-effort-099</code> - build a cache strategy to offset higher effort (click to expand)</summary>
...
<details>
<summary><code>reasoning-effort-100</code> - diagnose a save-but-lost-on-refresh bug before escalating effort (click to expand)</summary>
...
<details>
<summary><code>reasoning-effort-101</code> - design a fallback: low first, escalate on failure signals (click to expand)</summary>
...
<details>
<summary><code>reasoning-effort-102</code> - build a routing rule: fast lane vs deep lane (click to expand)</summary>
...
<details>
<summary><code>reasoning-effort-103</code> - analyze latency vs quality trade-offs (click to expand)</summary>
...
<details>
<summary><code>reasoning-effort-104</code> - design an eval to compare medium vs high on your workload (click to expand)</summary>
...
<details>
<summary><code>reasoning-effort-105</code> - build a regression pack that pins effort per task type (click to expand)</summary>
...
<details>
<summary><code>reasoning-effort-106</code> - pick effort for a CRUD ticket vs a distributed bug (click to expand)</summary>
...
<details>
<summary><code>reasoning-effort-107</code> - decide when xhigh/max is justified with a checklist (click to expand)</summary>
...
<details>
<summary><code>reasoning-effort-108</code> - write an incident note when max still fails (click to expand)</summary>
...
<details>
<summary><code>reasoning-effort-109</code> - tune effort for long-doc QA vs short chat (click to expand)</summary>
...
<details>
<summary><code>reasoning-effort-110</code> - create an effort-selection flowchart (click to expand)</summary>
...
<details>
<summary><code>reasoning-effort-111</code> - build a prompt+effort matrix for support macros (click to expand)</summary>
...
<details>
<summary><code>reasoning-effort-112</code> - tune verification depth alongside effort (click to expand)</summary>
...
<details>
<summary><code>reasoning-effort-113</code> - measure cost-per-task across efforts with retries counted (click to expand)</summary>
...
<details>
<summary><code>reasoning-effort-114</code> - build a cache strategy to offset higher effort (click to expand)</summary>
...
<details>
<summary><code>reasoning-effort-115</code> - diagnose a save-but-lost-on-refresh bug before escalating effort (click to expand)</summary>
...
<details>
<summary><code>reasoning-effort-116</code> - design a fallback: low first, escalate on failure signals (click to expand)</summary>
...
<details>
<summary><code>reasoning-effort-117</code> - build a routing rule: fast lane vs deep lane (click to expand)</summary>
...
<details>
<summary><code>reasoning-effort-118</code> - analyze latency vs quality trade-offs (click to expand)</summary>
...
<details>
<summary><code>reasoning-effort-119</code> - design an eval to compare medium vs high on your workload (click to expand)</summary>
...
<details>
<summary><code>reasoning-effort-120</code> - build a regression pack that pins effort per task type (click to expand)</summary>
